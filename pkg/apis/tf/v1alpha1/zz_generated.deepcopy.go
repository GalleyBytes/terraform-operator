...
func (in *AuthOpts) DeepCopyInto(out *AuthOpts) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthOpts.
func (in *AuthOpts) DeepCopy() *AuthOpts {
	if in == nil {
		return nil
	}
	out := new(AuthOpts)
